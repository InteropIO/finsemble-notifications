 ...
 * can communicate with other applications and has access to sand boxed system-level features.
 *
 * API Ready
...
declare namespace fin {
    ...
    interface OpenFinApplicationStatic {
         ...
         */
        new (options: ApplicationOptions, callback?: (successObj: {
            httpResponseCode: number;
        }) => void, errorCallback?: (reason: string, errorObj: NetworkErrorInfo) => void): OpenFinApplication;
        /**
    ...
    interface OpenFinExternalApplication {
         ...
         * Retrieves information about the application.
         */
        getInfo(callback?: (info: ExternalApplicationInfo) => void, errorCallback?: (reason: string, error: ErrorInfo) => void): void;
        /**
         * Registers an event listener on the specified event.
         */
    ...
    interface OpenFinSystem {
         ...
         */
        downloadPreloadScripts(scripts: DownloadPreloadOption[], callback?: (downloadInfo: DownloadPreloadInfo[]) => void, errorCallback?: (reason: string) => void): void;
        /**
         ...
         */
        getRuntimeInfo(callback?: (rvmInfo: RvmInfo) => void, errorCallback?: (reason: string) => void): void;
        /**
         ...
         * Opens the passed URL in the default web browser.
         */
        readRegistryValue(rootKey: string, subkey: string, value: string, callback?: (info: RegistryInfo) => void, errorCallback?: (reason: string) => void): void;
        /**
         ...
         */
        terminateExternalProcess(processUuid: string, timeout: number, killTree: boolean, callback?: (info: {
    ...
    interface OpenFinWindowStatic {
         ...
         * Class: Window
         *
         * new Window(options, callbackOptions, errorCallbackOptions)
         *
         ...
         */
        new (options: WindowOptions, callback?: (successObj: {
            httpResponseCode: number;
        }) => void, errorCallback?: (reason: string, errorObj: NetworkErrorInfo) => void): OpenFinWindow;
        /**
    ...
    type OpenFinTweenType = "linear" | "ease-in" | "ease-out" | "ease-in-out" | "ease-in-quad" | "ease-out-quad" | "ease-in-out-quad" | "ease-in-cubic" | "ease-out-cubic" | "ease-in-out-cubic" | "ease-out-bounce" | "ease-in-back" | "ease-out-back" | "ease-in-out-back" | "ease-in-elastic" | "ease-out-elastic" | "ease-in-out-elastic";
    type OpenFinApplicationEventType = "closed" | "connected" | "crashed" | "initialized" | "manifest-changed" | "not-responding" | "out-of-memory" | "responding" | "run-requested" | "started" | "tray-icon-clicked" | "window-alert-requested" | "window-auth-requested" | "window-closed" | "window-not-responding" | "window-created" | "window-end-load" | "window-navigation-rejected" | "window-show-requested" | "window-start-load";
    type OpenFinExternalApplicationEventType = "connected" | "disconnected";
    type OpenFinSystemEventType = "application-closed" | "application-crashed" | "application-created" | "application-started" | "desktop-icon-clicked" | "idle-state-changed" | "monitor-info-changed" | "session-changed";
    type OpenFinWindowEventType = "auth-requested" | "blurred" | "bounds-changed" | "bounds-changing" | "close-requested" | "closed" | "disabled-frame-bounds-changed" | "disabled-frame-bounds-changing" | "embedded" | "external-process-exited" | "external-process-started" | "focused" | "frame-disabled" | "frame-enabled" | "group-changed" | "hidden" | "initialized" | "maximized" | "minimized" | "navigation-rejected" | "restored" | "show-requested" | "shown";
